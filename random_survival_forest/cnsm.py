...
y_train = pd.read_csv("/home/spaethju/Dokumente/master-thesis/data/icgc/blood/large/features/final/cnsm_labels.csv").\
...
for train_index, test_index in kfold.split(x):
    ...
    X_train = X_train.drop("Y_cnsm_chrom_affected", axis=1)
